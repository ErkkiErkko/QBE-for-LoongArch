...
LOONGARCHOBJ  = loongarch/targ.o loongarch/abi.o loongarch/isel.o loongarch/emit.o
OBJ      = $(COMMOBJ) $(AMD64OBJ) $(ARM64OBJ) $(RV64OBJ) $(LOONGARCHOBJ)
...
config.h:
	...
	*)                                             \
		...
		*riscv64*)                             \
			...
			;;                             \
		*loongarch*)                             \
			echo "#define Deftgt T_loongarch";  \
			;;                             \
		*)                                     \
...
check-loongarch: qbe
	TARGET=loongarch tools/test.sh all
